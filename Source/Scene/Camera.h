...
public:
	...
	D3DXVECTOR3 GetFacing() // Facing direction of camera
	{
		return D3DXVECTOR3(GetViewMatrix().e13, GetViewMatrix().e23, GetViewMatrix().e33);
	}
	...
	CVector2 PixelFromWorldPtGetPt(CVector3 worldPt, TUInt32 ViewportWidth, TUInt32 ViewportHeight);
